...
function spawnSnake() {	
	var randomCell = Math.floor(Math.random() * FIELD_SIZE);   
	snake = field.children[randomCell - 1].children[randomCell - 3];
	snake.tail = field.children[randomCell - 1].children[randomCell - 2];
	snake.tail.tail = field.children[randomCell - 1].children[randomCell - 1];
